...
###########################
#Function written by Uttam to do online inference i.e. Regular Pneumonia tests
...
#Function written by Uttam to do online inference i.e. Covid19 tests
